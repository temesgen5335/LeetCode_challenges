...
class CustomStack:
    def __init__(self, maxSize: int):
        ...
        self.stack = []
        self.increment = [0] * maxSize  # To track increments
    ...
    def pop(self) -> int:
        ...
        top_value = self.stack.pop() + self.increment[idx]
        
        # If not empty, propagate the increment to the next element
        if idx > 0:
            self.increment[idx - 1] += self.increment[idx]
        
        # Reset the increment for the popped element
        self.increment[idx] = 0
    ...
    def inc(self, k: int, val: int) -> None:
        ...
        if k > 0:
            self.increment[k - 1] += val  # Increment the k-th element's increment
